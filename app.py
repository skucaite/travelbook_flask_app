...
import sys
import babel
from flask import Flask, render_template, url_for, flash, request   #, request, abort, jsonify
...
def delete_guide(guide_id):
  ...
  try:
      ...
      flash('There was a problem deleting that guide')
...
def create_travel():
    try:
        ...
        travel.insert()
        flash('Trip ' + form.title  + ' was successfully created!', 'success')
